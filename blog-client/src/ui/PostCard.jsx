...
const PostCard = ({ post }) => {
  return (
    <div className="group relative w-full shadow-md dark:border dark:border-gray-800  h-[350px] overflow-hidden rounded-lg  lg:w-[300px] sm:mx-auto transition-all duration-300">
