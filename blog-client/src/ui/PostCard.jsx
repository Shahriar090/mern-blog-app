...
const PostCard = ({ post }) => {
  return (
    <div className="group relative w-full border shadow-md hover:border-2 h-[350px] overflow-hidden rounded-lg sm:w-[350px] sm:mx-auto transition-all duration-300">
